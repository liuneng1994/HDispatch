...
(function ($)
{
    ...
    {
        if(!options)options={};
        var afterSelectFunc=options.onAfterSelectTabItem;
        options.onAfterSelectTabItem=function(){
            $(window).trigger('resize');
            if(afterSelectFunc instanceof Function)
                afterSelectFunc.apply(this,arguments);
        }
