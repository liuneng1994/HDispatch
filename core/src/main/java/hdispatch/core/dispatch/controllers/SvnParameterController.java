...
public class SvnParameterController extends BaseController{
    ...
    @ResponseBody
    public ResponseData addSvnParameters(@RequestBody List<SvnParameter> svnParameterList, BindingResult result, HttpServletRequest request) {
    ...
    @ResponseBody
    public ResponseData updateJobs(@RequestBody List<SvnParameter> svnParameterList, BindingResult result, HttpServletRequest request) {
