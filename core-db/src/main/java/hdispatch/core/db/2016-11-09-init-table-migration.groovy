...
databaseChangeLog(logicalFilePath:"2016-11-09-init-table-migration.groovy"){
    changeSet(author: "yazheng young", id: "20161109-table-hdispatch-group-1") {
        sqlFile(path: MigrationHelper.getInstance().dataPath("hdispatch/core/db/data/mysql/tables/hdispatch_group.sql"), encoding: "UTF-8")
    }
    changeSet(author: "yazheng young", id: "20161109-table-hdispatch-group-dependency-1") {
    ...
    changeSet(author: "yazheng young", id: "20161109-table-hdispatch-job-property-1") {
    ...
    changeSet(author: "yazheng young", id: "20161109-table-hdispatch-schedule-1") {
    ...
    changeSet(author: "yazheng young", id: "20161109-table-hdispatch-workflow-1") {
    ...
    changeSet(author: "yazheng young", id: "20161109-table-hdispatch-workflow-job-1") {
    ...
    changeSet(author: "yazheng young", id: "20161109-table-hdispatch-workflow-property-1") {
    ...
    changeSet(author: "yazheng young", id: "20161109-table-mut-flows-1") {
        sqlFile(path: MigrationHelper.getInstance().dataPath("hdispatch/core/db/data/mysql/tables/mut_flows.sql"), encoding: "UTF-8")
    }
    changeSet(author: "yazheng young", id: "20161109-table-dep-flows-1") {
