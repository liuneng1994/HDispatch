...
databaseChangeLog(logicalFilePath:"2016-11-09-init-table-migration.groovy"){
    changeSet(author: "yazheng young", id: "20161109-init-data-xlsx", runAlways:"true"){
        customChange(class:ExcelDataLoader.class.name){
            param(name:"filePath",value:MigrationHelper.getInstance().dataPath("hbi/core/db/data/2016-11-15-init-data.xlsx"))
        }
    }
}