...
databaseChangeLog(logicalFilePath:"2016-11-07-init-table-migration.groovy"){
    ...
    //需要单独执行
//    changeSet(author: "young", id: "20161107-table-hdispatch-permission-function-1") {
...
//    }
    changeSet(author: "young", id: "20161107-table-hdispatch-themegroup-1") {
    ...
    changeSet(author: "young", id: "20161107-table-hdispatch-themegroup-theme-1") {
    ...
    changeSet(author: "young", id: "20161107-table-hdispatch-authority-1") {
